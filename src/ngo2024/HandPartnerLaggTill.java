 ...
 * @author Ägaren
 */
public class HandPartnerLaggTill extends javax.swing.JFrame {
    private InfDB idb;
private String InloggadAnvandareH;

    /**
     * Creates new form HandPartnerLaggTill
     */
    public HandPartnerLaggTill(InfDB idb, String InloggadAnvandareH) {
        this.idb = idb;
    ...
    private void initComponents() {
        ...
        lbEpostProjektledare.setText("jLabel9");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel1.setText("Lägg till / ta bort partner");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HandPartnerLaggTill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              //  new HandPartnerLaggTill().setVisible(true);
            }
        });
    }
