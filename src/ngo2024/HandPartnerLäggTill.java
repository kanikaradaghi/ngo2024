 ...
 * @author Ägaren
 */
public class HandPartnerLäggTill extends javax.swing.JFrame {

    /**
     * Creates new form HandPartnerLäggTill
     */
    public HandPartnerLäggTill() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HandPartnerLäggTill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HandPartnerLäggTill().setVisible(true);
            }
        });
    }
